 ...
 *      Author: 王志涵
 *      brief: 若直接移植ad9959驱动，不通过cubemx配置IO引脚，可直接将ad9959_GPIO_Init()取消注释，并取消头文件中引脚重命名注释
 */
...
//  ad9959_GPIO_Init(); //GPIO初始化
    ad9959_io_init();//IO初始化
    ad9959_reset();//9959复位
