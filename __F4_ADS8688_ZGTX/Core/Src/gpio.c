...
void MX_GPIO_Init(void)
{
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, ADS8688_SDI_Pin|ADS8688_RST_PD_Pin|ADS8688_DAISY_Pin|ADS8688_SCLK_Pin, GPIO_PIN_RESET);
  ...
  GPIO_InitStruct.Pin = ADS8688_SDI_Pin|ADS8688_RST_PD_Pin|ADS8688_DAISY_Pin|ADS8688_SCLK_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
