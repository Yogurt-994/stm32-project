...
//  W25QXX_Write_NoCheck(writeData,0x00,sizeof(writeData));
//  for(;;){
//	  HAL_Delay(500);
//	  W25QXX_Read(readData,0x00,sizeof(writeData));
//	  HAL_Delay(100);
//	  print(&huart2,"%s\r\n",readData);
//
//  }
...
//  AT24CXX_Write(0x00,writeData,sizeof(writeData));
//  HAL_Delay(100);
//  for(;;){
//	  HAL_Delay(500);
//	  AT24CXX_Read(0x00,readData,sizeof(writeData));
//	  HAL_Delay(100);
//	  print(&huart2,"%s\r\n",readData);
//  }
