...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, CS_Pin|RST_Pin|RS_Pin|SDA_Pin
                          |SCLK_Pin|ROM_CS_Pin|ROM_SCK_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin PBPin
                           PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = CS_Pin|RST_Pin|RS_Pin|SDA_Pin
                          |SCLK_Pin|ROM_CS_Pin|ROM_SCK_Pin;
