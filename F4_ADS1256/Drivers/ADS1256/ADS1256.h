...
//#define	SCLK_H		PAout(12)=1
//#define	SCLK_L		PAout(12)=0
//#define	DIN_H		PAout(11)=1
//#define	DIN_L		PAout(11)=0
//#define DO_IS_H		PAin(10)
//#define DRDY_IS_H	PAin(9)
//#define	CS_H		PAout(8)=1
//#define	CS_L		PAout(8)=0
//#define RST_H		PCout(9)=1
//#define RST_L		PCout(9)=0
#define	SCLK_H		PDout(0)=1
#define	SCLK_L		PDout(0)=0
#define	DIN_H		PDout(1)=1
#define	DIN_L		PDout(1)=0
#define DO_IS_H		PDin(3)
#define DRDY_IS_H	PDin(4)
#define	CS_H		PDout(2)=1
#define	CS_L		PDout(2)=0
#define RST_H		PDout(5)=1
#define RST_L		PDout(5)=0
