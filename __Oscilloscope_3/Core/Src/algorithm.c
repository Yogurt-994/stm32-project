...
float
AD_arr1[2][AD_Size1] = {0,},
*pAD_arr1, *pAD_arr_end1,

AD_arr2[2][AD_Size2] = {0,},
*pAD_arr2, *pAD_arr_end2,

AD_arr3[2][AD_Size3] = {0,},
...
float
TFT_arr1[2][AD_Size1] = {0,},
*pTFT_arr1, *pTFT_arr_end1,

TFT_arr2[2][AD_Size2] = {0,},
...
void Calc_array(ArrayParam_T *params,float* calc_addr,u32 calc_len)
{
    ...
    params->rmsDivideVpp = params->Rms/params->Vpp;						//波形识别所用
}
void Calc_array1(ArrayParam_T *params,float* calc_addr,u32 calc_len){
	...
	arm_max_f32(calc_addr1,calc_len-1,&params->max,&useless);  			//计算最大值
	arm_min_f32(calc_addr1,calc_len-1,&params->min,&useless);  			//计算最小值
	params->Vpp=params->max-params->min;                   				//计算出峰峰值
	arm_mean_f32(calc_addr1,calc_len-1,&params->Aver);    				//计算平均值
	arm_rms_f32(calc_addr1,calc_len-1,&params->Rms);      				//计算有效值
	params->rmsDivideVpp = params->Rms/params->Vpp;						//波形识别所用
}
