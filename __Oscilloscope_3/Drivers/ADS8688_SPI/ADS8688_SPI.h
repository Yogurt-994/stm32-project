...
#ifndef ADS8688_SPI_ADS8688_SPI_H_
#define ADS8688_SPI_ADS8688_SPI_H_

// include the correct file according to you MCU
#include "main.h"

#define SAMPLE_END  HAL_GPIO_WritePin(ADS8688_CS_GPIO_Port,ADS8688_CS_Pin,SET)
#define SAMPLE_BEGIN  HAL_GPIO_WritePin(ADS8688_CS_GPIO_Port,ADS8688_CS_Pin,RESET)
...
#define AD_mv_Scale   20480/65535
// --------------------------------------------------------------------------- //
 ...
 *
 */
uint8_t ADS8688_CH1_Init_Mult(ADS8688 *ads, SPI_HandleTypeDef *spiHandle, GPIO_TypeDef *csPinBank, uint16_t csPin);
uint8_t ADS8688_CH2_Init_Mult(ADS8688 *ads, SPI_HandleTypeDef *spiHandle, GPIO_TypeDef *csPinBank, uint16_t csPin);
...
#endif /* ADS8688_SPI_ADS8688_SPI_H_ */
